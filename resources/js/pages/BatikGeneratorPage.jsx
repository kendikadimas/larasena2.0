   ...
   const promptTemplates = [
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Only add pattern specifications if repeat count is not 0 (default)
            if (repeatCount > 0) {
                enhancedPrompt = `${prompt}, ${style} style, ${colorScheme} color scheme, ${patternType} pattern, repeated ${repeatCount}x${repeatCount}`;
            }
