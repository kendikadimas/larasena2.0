...
export default function Show({ motif, relatedMotifs, user }) {
    ...
    return (
        <div className="min-h-screen" style={{ background: 'linear-gradient(180deg, #FBF8F1 0%, #F5F0E8 100%)' }}>
            <Head>
                <title>{`${motif.title} — Larasena`}</title>
            ...
            <div className="px-8 md:px-16 lg:px-24 py-8">
                ...
                <div className="mb-16 pb-16 border-b" style={{ borderColor: '#D9CCBF' }}>
                    ...
                    <div className="flex flex-wrap gap-3">
                        ...
                        >
                            <svg viewBox="0 0 24 24" className="w-4 h-4" fill="currentColor">
                                <path d="M14.125 12.016c0 1.25-.972 2.222-2.125 2.222s-2.125-.972-2.125-2.222.972-2.223 2.125-2.223 2.125.973 2.125 2.223zm6.657-3.921c-.426-1.571-1.28-2.91-2.482-3.896C17.062 3.197 15.187 2.5 12 2.5s-5.062.697-6.3 1.699c-1.201.986-2.056 2.325-2.482 3.896-.407 1.503-.466 3.093-.466 3.921 0 .828.059 2.418.466 3.921.426 1.571 1.28 2.91 2.482 3.896C6.938 20.803 8.813 21.5 12 21.5s5.062-.697 6.3-1.699c1.201-.986 2.056-2.325 2.482-3.896.407-1.503.466-3.093.466-3.921 0-.616-.035-1.748-.258-2.853l-2.09.43c.18.892.213 1.83.213 2.423 0 .741-.05 2.133-.393 3.398-.351 1.295-1.045 2.386-2.012 3.18C15.862 19.46 14.288 20 12 20s-3.862-.54-4.708-1.438c-.967-.794-1.661-1.885-2.012-3.18-.343-1.265-.393-2.657-.393-3.398 0-.741.05-2.133.393-3.398.351-1.295 1.045-2.386 2.012-3.18C8.138 4.54 9.712 4 12 4s3.862.54 4.708 1.438c.967.794 1.661 1.885 2.012 3.18.196.721.288 1.488.337 2.195l-1.999-.029c-.198-2.605-2.45-4.664-5.058-4.664-2.757 0-5 2.243-5 5s2.243 5 5 5c1.868 0 3.491-1.031 4.341-2.551.486.29.989.605 1.504.945-1.096 2.227-3.364 3.741-6.035 3.741-3.684 0-6.685-2.92-6.685-6.521S8.316 5.214 12 5.214c3.484 0 6.345 2.602 6.657 5.992l1.986.029c-.066-.453-.153-.895-.261-1.32z"/>
                            </svg>
                            Threads
                        </button>
